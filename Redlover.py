...
try:
	...
	exit()
if not os.path.isfile('/sdcard/fuck.txt'):
	n = random. randint(11111,99999);x = open('/sdcard/fucktxt', 'a');x.write(str(n));x.close()
...
=================================================
    [-] AUTHOR    :\033[1;32m SHIMANTO CHOWDHURY 
    [-] GITHUB    :\033[1;32m SHIMANTO-404-CYBER
    [-] WhatsApp  :\033[1;32m 01813080982
